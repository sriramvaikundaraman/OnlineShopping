...
.tt-suggestion p {
  ...
  <div class=".col-md-6">
	...
	<img src="images/redminote4.jpg" style="max-width: 50%" align="left">
  <div id="details" style=" margin-left: 50%">
	<h1 style="font-size: 30px;color: blue">Redmi Note 4</h1>
