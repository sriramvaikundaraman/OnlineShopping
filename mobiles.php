...
$sql = " SELECT brand,price FROM items where category='mobiles'";
...
.tt-suggestion p {
  ...
  <body>
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container" style="max-height: 45px">
  ...
  <div class=".col-md-6">
    ...
    <div class="bs-example">
        ...
        <input type="submit" style="margin-top: 25px" name="Go">
    </div>
  </div>
  </div>
...
<div class="w3-container" style="margin-top:60px;margin-left: 400px">
  <br>
