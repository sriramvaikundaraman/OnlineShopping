...
.tt-suggestion p {
  ...
  <div class=".col-md-6">
	...
	<img src="images/redminote3.jpg" style="max-width: 50%" align="left">
  <div id="details" style=" margin-left: 50%">
	<h1 style="font-size: 30px;color: blue">Redmi Note 3</h1>
	<li style="font-size: 24px;">
		<ul><b>RAM:</b>3GB</ul>
		<ul><b>Processor:</b>1.6Ghz Snapdragon 660</ul>
