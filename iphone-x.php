...
.tt-suggestion p {
  ...
  <div class=".col-md-6">
	...
	<img src="images/iphone-x.jpg" style="max-width: 50%" align="left">
  <div id="details" style=" margin-left: 50%">
	<h1 style="font-size: 30px;color: blue">iPhone-X</h1>
	<li style="font-size: 24px;">
		<ul><b>RAM:</b>4GB</ul>
		<ul><b>OS:</b>iOS 12</ul>
		<ul><b>Camera:</b>13mp primary and 5mp secondary</ul>
		<ul><b>SIM:</b>Single sim  4G LTE</ul>
    <ul><b>Storage:</b>128GB</ul>
		<ul><b>Battery:</b>3000mAH</ul>
    <ul><b>Cost:</b>Rs.99999/-</ul>
	</li>
	<form action="buy.php">
