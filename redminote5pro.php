...
.tt-suggestion p {
  ...
  <div class=".col-md-6">
	...
	<img src="images/redminote5pro.jpg" style="max-width: 50%" align="left">
  <div id="details" style=" margin-left: 50%">
	<h1 style="font-size: 30px;color: blue">Redmi Note 5 Pro</h1>
	<li style="font-size: 24px;">
		<ul><b>RAM:</b>6GB</ul>
		<ul><b>Processor:</b>2.0Ghz Exynos</ul>
		<ul><b>Camera:</b>12mp and 5mp dual primary and 20mp secondary AI</ul>
		<ul><b>SIM:</b>Dual sim and dual standby 4G LTE</ul>
    <ul><b>Storage:</b>64GB</ul>
		<ul><b>Battery:</b>4000mAH</ul>
