...
.tt-suggestion p {
  ...
  <div class=".col-md-6">
	...
	<img src="images/dell-inspiron15-3000.jpg" style="max-width: 50%" align="left">
  <div id="details" style=" margin-left: 50%">
	<h1 style="font-size: 30px;color: blue" align="center">DELL inspiron15 3000 series</h1>
	<li style="font-size: 24px;">
		<ul><b>RAM:</b>4GB</ul>
		<ul><b>Processor:</b>intel i3</ul>
		<ul><b>Display  </b>720p 15.5" Intel Graphics</ul>
    <ul><b>Storage:</b>64GB</ul>
		<ul><b>Battery:</b>3000mAH</ul>
    <ul><b>Cost:</b>Rs.32000/-</ul>
	</li>
	<form action="buy.php">
	...
	<?php
	$_SESSION['booked']="dell-inspiron15-3000";
	?>
</body>
</html>