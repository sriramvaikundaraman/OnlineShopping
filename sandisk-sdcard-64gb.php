...
.tt-suggestion p {
  ...
  <div class=".col-md-6">
	...
	<img src="images/sandisk-sdcard-64gb.jpg" style="max-width: 50%" align="left">
  <div id="details" style=" margin-left: 50%">
	<h1 style="font-size: 30px;color: blue" align="center">Sandisk SD card 64GB</h1>
	<li style="font-size: 24px;">
		<ul><b>Rating:</b>4.5 stars</ul>
    <ul><b>Storage:</b>64GB</ul>
     <ul><b>Cost:</b>Rs.1699/-</ul>
	</li>
	<form action="buy.php">
	...
	<?php
	$_SESSION['booked']="sandisk-sdcard-64gb";
	?>
</body>
</html>