...
.tt-suggestion p {
  ...
  <div class=".col-md-6">
	...
	<img src="images/dell-inspiron15-5000.jpg" style="max-width: 50%" align="left">
  <div id="details" style=" margin-left: 50%">
	<h1 style="font-size: 30px;color: blue" align="center">DELL inspiron15 5000 series</h1>
	<li style="font-size: 24px;">
		<ul><b>RAM:</b>8GB</ul>
		<ul><b>Processor:</b>intel i5</ul>
		<ul><b>Display  </b>1080p 15.5" Intel Graphics</ul>
    <ul><b>Storage:</b>2TB</ul>
		<ul><b>Battery:</b>3000mAH</ul>
    <ul><b>Cost:</b>Rs.55000/-</ul>
	</li>
	<form action="buy.php">
	...
	<?php
	$_SESSION['booked']="dell-inspiron15-5000";
	?>
</body>
</html>