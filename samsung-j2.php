...
.tt-suggestion p {
  ...
  <div class=".col-md-6">
    ...
    <div id="main" style="margin-top: 40px;">
    	<a href="images/samsung-j2.jpg">
	<img src="images/samsung-j2.jpg" align="left">
</a>
	<h1 style="font-size: 30px;color: blue">Samsung J2</h1>
	<li style="font-size: 24px;">
		<ul><b>RAM:</b>2GB</ul>
		<ul><b>Processor:</b>1.2Ghz Exynos</ul>
		<ul><b>Camera:</b>5mp primary and 2mp secondary</ul>
		<ul><b>SIM:</b>Dual sim and dual standby 4G LTE</ul>
		<ul><b>Battery:</b>2000mAH</ul>
		<ul><b>Cost:</b>Rs.7500/-</ul>
	</li>
	<form action="buy.php">
