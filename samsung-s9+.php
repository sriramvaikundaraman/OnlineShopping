...
.tt-suggestion p {
  ...
  <div class=".col-md-6">
	...
	<img src="images/samsung-s9+.jpg" style="max-width: 50%" align="left">
  <div id="details" style=" margin-left: 50%">
	<h1 style="font-size: 30px;color: blue">Samsung s9 plus</h1>
	<li style="font-size: 24px;">
		<ul><b>RAM:</b>8GB</ul>
		<ul><b>Processor:</b>2.8Ghz Exynos</ul>
		<ul><b>Camera:</b>12mp primary and 24mp secondary</ul>
		<ul><b>SIM:</b>Dual sim and dual standby 4G LTE</ul>
    <ul><b>Storage:</b>128GB</ul>
		<ul><b>Battery:</b>3200mAH</ul>
    <ul><b>Cost:</b>Rs.69999/-</ul>
	</li>
	<form action="buy.php">
