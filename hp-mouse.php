...
.tt-suggestion p {
  ...
  <div class=".col-md-6">
	...
	<img src="images/hp-mouse.jpg" style="max-width: 50%" align="left">
  <div id="details" style=" margin-left: 50%">
	<h1 style="font-size: 30px;color: blue" align="center">HP mouse</h1>
	<li style="font-size: 24px;">
		<ul><b>Rating:</b>4.5 stars</ul>
    <ul><b>Type:</b>USB 2.0</ul>
     <ul><b>Cost:</b>Rs.500/-</ul>
	</li>
	<form action="buy.php">
