...
.tt-suggestion p {
  ...
  <div class=".col-md-6">
	...
	<img src="images/vivo-v9.jpg" style="max-width: 50%" align="left">
  <div id="details" style=" margin-left: 50%">
	<h1 style="font-size: 30px;color: blue">Vivo v9</h1>
	<li style="font-size: 24px;">
		<ul><b>RAM:</b>4GB</ul>
		<ul><b>Processor:</b>2.0Ghz Exynos</ul>
		<ul><b>Camera:</b>13mp and 13mp dual primary and 5mp secondary</ul>
		<ul><b>SIM:</b>Dual sim and dual standby 4G LTE</ul>
    <ul><b>Storage:</b>64GB</ul>
		<ul><b>Battery:</b>3000mAH</ul>
    <ul><b>Cost:</b>Rs.12999/-</ul>
	</li>
	<form action="buy.php">
