...
.tt-suggestion p {
  ...
  <div class=".col-md-6">
	...
	<img src="images/hp-pavilion-13.jpg" style="max-width: 50%" align="left">
  <div id="details" style=" margin-left: 50%">
	<h1 style="font-size: 30px;color: blue" align="center">HP pavilion 13</h1>
	<li style="font-size: 24px;">
		<ul><b>RAM:</b>4GB</ul>
		<ul><b>Processor:</b>intel i5 3.2GHz</ul>
		<ul><b>Display  </b>720p 15.5" Intel Graphics</ul>
    <ul><b>Storage:</b>1TB</ul>
		<ul><b>Battery:</b>3000mAH</ul>
    <ul><b>Cost:</b>Rs.44000/-</ul>
	</li>
	<form action="buy.php">
	...
	<?php
	$_SESSION['booked']="hp-pavilion-13";
	?>
</body>
</html>